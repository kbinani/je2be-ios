func gettext(_ s: String) -> String {
    ...
    case "ja-JP":
        ...
        case "Choose a GAMEDATA file of PS3 Edition data to start conversion": return "PS3版のGAMEDATAファイルを選択"
        ...
        case "PS3 to Bedrock": return "PS3版 から 統合版に"
        case "PS3 to Java": return "PS3版 から Java版に"
