func gettext(_ s: String) -> String {
    ...
    case "ja-JP":
        ...
        case "Choose a bin file of Xbox 360 Edition data to start conversion": return "Xbox360版のデータ, bin ファイルを選択してください"
        case "Choose a zip file of Java Edition world data to start conversion": return "Java版のデータをzip圧縮したファイルを選択してください"
        case "Choose an mcworld file to start conversion": return "mcworld ファイルを選択してください"
